...
class Client extends \ShipStream\Ups\Api\Runtime\Client\Client
{
    ...
    */
     ...
     */
    public function delete(string $version, array $headerParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     */
    public function freightCancelPickup(string $version, array $headerParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
